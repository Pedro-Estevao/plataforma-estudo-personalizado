...
const Introduction = () => {
    ...
    return (
        <div className={`fixed top-0 left-0 right-0 bottom-0 bg-white dark:bg-[#18181c] h-[100lvh] w-[100lvw] z-[999] overflow-y-auto`}>
            <div className="flex flex-col items-center justify-between gap-12 p-10 max-sm:px-3 w-full min-h-[100lvh]">
                <AnimatePresence mode='popLayout'>
                    ...
                    >
                        <Image src={'/imgs/gemini-logo.png'} className="select-none" width={300} height={150} priority alt="Logo Gemini" />
                    </motion.div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <CustomRadio value="Informal">
                                            <Image src={'/imgs/informal.jpeg'} className="rounded-br-[8px] rounded-bl-[8px]" width={225} height={225} priority alt="Imagem para representar a personalidade Informal" />
